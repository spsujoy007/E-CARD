...
function App() {
  ...
  return (
    <div className='min-h-screen md:p-10 p-3 md:w-[45%] mx-auto'>
        <div className='w-full bg-[#ffffff3b] p-5 border-[0px] border-[#996f5eac] rounded-lg'>
          <div>
          ...
          <div className='flex flex-col md:flex-row space-x-2 w-full mt-5 border-[0px] border-[#b78b7aac] p-2 rounded-lg'>

                        ...
                        <div className='h-full flex items-end p-5 '>
                            ...
                            <div className=' flex items-center gap-2 mt-5'>
                                <div className='w-[45px] h-[45px] rounded-full'>
                                    <img style={{borderColor: `${averageColor}`}} className={`rounded-full p-[2px] h-full object-cover w-full border-[2px]`} src={avatar ? avatar : "../../public/assets/null_avatar.jpg"} alt="" />
                                </div>
